<?php
    ...
    if (isset($_POST['country']) && isset($_POST['token']) && $_POST['token'] === $_SESSION['token']) {
...
?>
<h1>What country are you from?</h1>
<sub>Gameplay can be affected depending on your choice.</sub>
<form onsubmit="inlinePopupSubmit($(this),'editProfileCountry'); return false;">
